    ...
    <section className="Skills" id="skills">
      ...
      >
        <div className="text">
          ...
          <p>
            Here's the toolkit I rely on day to day: React and Next.js on the
            frontend, Node.js/Express on the backend, SQL and NoSQL databases,
            and secure authentication baked into everything I ship.
          </p>

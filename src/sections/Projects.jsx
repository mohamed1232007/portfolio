                ...
                <div className="projects-container">
                    ...
                    >
                        <div className="project-info">
                            ...
                            <p>
                                ...
                                Role-Based Access Control (RBAC). Includes
                                separate dynamic interfaces for regular users
                                and administrators, strict route protection
                                preventing unauthorized access, and full
                    ...
                    >
                        <div className="project-info">
                            ...
                            <div className="tech-tags">
                                ...
                                <span>REST API</span>
                                <span>JWT</span> <span>Axios</span>
                            </div>
                            <p>
                                A full-stack role-based task management web
                                application that streamlines workflow between
                                administrators and team members with real-time
                                status tracking and dedicated dashboards.
                            </p>

                            <div className="project-links">
                                <a
                                    href="https://team-pulse-mo-1207.vercel.app/"
                                    target="_blank"
                                    className="btn-sm"
                                >
                                    <i className="fa-solid fa-arrow-up-right-from-square"></i>
                                ...
                                <a
                                    href="https://github.com/mohamed1232007/TeamPulse"
                                    target="_blank"
                                    className="btn-sm outline"
                                >
                                    <i className="fa-brands fa-github"></i>{" "}
                    ...
                    >
                        <div className="project-info">
                            ...
                            <p>
                                Comprehensive e-commerce application engineered
                                with React 19 and TypeScript for compile-time
                                type-safety and bug prevention. Integrated
                                dynamic product fetching and hosted on AWS.
                            </p>
                            <div className="project-links">
                                <a
                    ...
                    >
                        <div className="project-info">
                            ...
                            <p>
                                Fully responsive tech-products online store.
                                Features dynamic data fetching and parsing from
                                local <strong>JSON files</strong> to mimic real
                                APIs, with cart persistence via LocalStorage.
                            </p>
                            <div className="project-links">
                                <a
                    ...
                    >
                        <div className="project-info">
                            ...
                            <p>
                                Interactive chatbot UI built using modular React
                                components and state management. Features
                                real-time message log updates, event handling,
                                and modern UI responses.
                            </p>
                            <div className="project-links">
                                <a
                    ...
                    >
                        <div className="project-info">
                            ...
                            <p>
                                Real-time customer support platform featuring
                                instant live chat, a ticketing system for
                                complaints, and a protected Admin Dashboard for
